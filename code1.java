    ...
    static SupervisorCoderSystem createDefault() {
        return new SupervisorCoderSystem() {
            ...
            public String code(String request, String workingDirectory, String mode) {
                ...
                ctx.put(UserRequest.class, request);
                ctx.put(WorkingDirectory.class, workingDirectory);
        ...
        // Marker key types for the context map
        record UserRequest(String v)    { static final Class<?> type = UserRequest.class; }
        record WorkingDirectory(String v) {}
        record DetectedTools(String v)  {}
        record TargetScope(String v)    {}
    }
}
